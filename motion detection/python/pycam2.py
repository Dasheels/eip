...
# Sensitivity        - how many changed pixels before capturing an image, needs to be higher if noisy view, 200 = 2m motion detection for big changes
...
diskSpaceToReserve = 5000 * 1024 * 1024 # Keep 5 Gb free on disk
cameraSettings = ""
